...
* Set up a remote repository. You can e.g. create a project in GitHub or GitLab and run
  ...
  For a seamless integration, the name of the project should also be `installation-instruction`.
* Head to your user settings at `https://pypi.org` and setup PyPI trusted publishing.
  ...
  * PyPI project name: `installation_instruction`
  * Owner: `None`
  * Repository name: `installation-instruction`
