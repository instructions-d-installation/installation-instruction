...
* Python source files:
  * The Python package source files are located in the `installation_instruction` directory.
  * `tests/test_installation_instruction.py` contains the unit tests for the package.
